          ...
          <div className="button-group">
            <button className="download-button" onClick={handleDownload}>
              <div className="button-content">
                <img src="/android-4.svg" alt="Android" width="auto" height="25" style={{ marginRight: '8px', flexShrink: 0, marginTop: '-12px' }} />
                <div className="button-text">
                  <span>Download App</span>
                  {stats.downloads !== null && (
                    <span className="button-stats">{stats.downloads.toLocaleString()} downloads</span>
                  )}
                </div>
              </div>
            </button>
